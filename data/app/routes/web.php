...
$app->get('/admin', 'App\Controllers\web\AdminController:getLogin')->setName('login.admin');
$app->post('/admin/login', 'App\Controllers\web\AdminController:login')->setName('admin.login');
...
$app->group('', function() use ($app, $container) {
    ...
    $app->group('/item', function() use ($app, $container) {
        ...
        $app->get('/show', 'App\Controllers\web\ItemController:showItem')->setName('get.item');
        ...
        $app->get('/user/delete/{item}', 'App\Controllers\web\ItemController:deleteItemByUser')->setname('user.delete.item');
        ...
        $app->get('/image/delete/{image}', 'App\Controllers\web\ItemController:deleteImage')->setName('delete.item.image');
        $app->post('/update', 'App\Controllers\web\ItemController:update')->setName('item.update');
        $app->post('/create', 'App\Controllers\web\ItemController:createByUser')->setname('create.item');
    });
    ...
    $app->group('/user', function() use ($app, $container) {
        ...
        $app->post('/create/item', 'App\Controllers\web\ItemController:createByUser')->setName('user.create.item');
    });
    ...
    $app->group('/pic', function() use ($app, $container){
        ...
        $app->get('/group/member/search', 'App\Controllers\web\PicController:searchUser')->setName('web.pic.search.user');
        ...
        $app->get('/show/item', 'App\Controllers\web\PicController:getItem')->setName('pic.get.item');
