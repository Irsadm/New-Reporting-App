...
$app->group('/api', function() use ($app, $container) {
    ...
    $app->group('/guard', function() use ($app, $container) {
        ...
        $app->post('/request/guardian/{guard}', 'App\Controllers\api\GuardController:requestByUser')->setname('api.fellow.request');
        $app->post('/request/fellow/{user}', 'App\Controllers\api\GuardController:requestByGuard')->setname('api.guardian.request');
